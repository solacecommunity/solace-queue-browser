...
export class BrokerLinksModel {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('systemInformationUri'))
        obj.systemInformationUri = ApiClient.convertToType(data['systemInformationUri'], 'String');
 ...
 * @member {String} systemInformationUri
 */
BrokerLinksModel.prototype.systemInformationUri = undefined;
