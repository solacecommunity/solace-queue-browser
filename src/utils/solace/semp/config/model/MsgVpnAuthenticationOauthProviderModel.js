...
export class MsgVpnAuthenticationOauthProviderModel {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tokenIntrospectionPassword'))
        obj.tokenIntrospectionPassword = ApiClient.convertToType(data['tokenIntrospectionPassword'], 'String');
 ...
 * @member {String} tokenIntrospectionPassword
 */
MsgVpnAuthenticationOauthProviderModel.prototype.tokenIntrospectionPassword = undefined;
