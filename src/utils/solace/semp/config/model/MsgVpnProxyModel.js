...
/**
 * The password to use with basic authentication. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `\"\"`.
 * @member {String} authenticationBasicPassword
 */
MsgVpnProxyModel.prototype.authenticationBasicPassword = undefined;

/**
 * The username to use with basic authentication. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `\"\"`.
...
/**
 * The authentication scheme used to connect to the proxy. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `\"none\"`. The allowed values and their meaning are:  <pre> \"none\" - No authentication. \"basic\" - Username/password authentication. </pre> 
...
/**
 * Enable or disable the proxy. When disabled, no connections are initiated to this particular Proxy. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `false`.
 * @member {Boolean} enabled
 */
MsgVpnProxyModel.prototype.enabled = undefined;

/**
 * The IP address or host name of the proxy. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `\"\"`.
 * @member {String} host
 */
...
/**
 * The port to connect to on the proxy host. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `0`.
 * @member {Number} port
 */
...
/**
 * The type of proxy. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `\"direct\"`. The allowed values and their meaning are:  <pre> \"direct\" - Direct connection (no proxy). \"http\" - HTTP proxy. </pre> 
