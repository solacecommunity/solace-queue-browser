 ...
 */
MsgVpnKafkaSenderModel.prototype.authenticationBasicPassword = undefined;

/**
 * The username the Kafka Sender uses to login to the remote Kafka broker. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`.
 ...
 */
MsgVpnKafkaSenderModel.prototype.authenticationClientCertContent = undefined;
 ...
 */
MsgVpnKafkaSenderModel.prototype.authenticationClientCertPassword = undefined;
 ...
 */
MsgVpnKafkaSenderModel.prototype.authenticationOauthClientSecret = undefined;

/**
 * The OAuth token endpoint URL that the Kafka Sender will use to request a token for login to the Kafka broker. Must begin with \"https\". Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`.
 ...
 */
MsgVpnKafkaSenderModel.prototype.authenticationScramPassword = undefined;
...
/**
 * Maximum number of messages sent in a single batch. Batching is done for all Senders on a per-partition basis. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `10000`.
