...
export class MsgVpnBridgeModel {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('remoteAuthenticationBasicPassword'))
        obj.remoteAuthenticationBasicPassword = ApiClient.convertToType(data['remoteAuthenticationBasicPassword'], 'String');
      if (data.hasOwnProperty('remoteAuthenticationClientCertContent'))
        obj.remoteAuthenticationClientCertContent = ApiClient.convertToType(data['remoteAuthenticationClientCertContent'], 'String');
      if (data.hasOwnProperty('remoteAuthenticationClientCertPassword'))
        obj.remoteAuthenticationClientCertPassword = ApiClient.convertToType(data['remoteAuthenticationClientCertPassword'], 'String');
 ...
 * @member {String} remoteAuthenticationBasicPassword
 */
MsgVpnBridgeModel.prototype.remoteAuthenticationBasicPassword = undefined;
 ...
 * @member {String} remoteAuthenticationClientCertContent
 */
MsgVpnBridgeModel.prototype.remoteAuthenticationClientCertContent = undefined;

/**
 * The password for the client certificate. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Modifying this attribute while the object (or the relevant part of the object) is administratively enabled may be service impacting as enabled will be temporarily set to false to apply the change. The default value is `\"\"`. Available since 2.9.
 * @member {String} remoteAuthenticationClientCertPassword
 */
MsgVpnBridgeModel.prototype.remoteAuthenticationClientCertPassword = undefined;
