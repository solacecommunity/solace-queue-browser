...
export class BrokerLinksModel {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('configSyncAssertLeaderMsgVpnUri'))
        obj.configSyncAssertLeaderMsgVpnUri = ApiClient.convertToType(data['configSyncAssertLeaderMsgVpnUri'], 'String');
      if (data.hasOwnProperty('configSyncAssertLeaderRouterUri'))
        obj.configSyncAssertLeaderRouterUri = ApiClient.convertToType(data['configSyncAssertLeaderRouterUri'], 'String');
      if (data.hasOwnProperty('configSyncResyncFollowerMsgVpnUri'))
        obj.configSyncResyncFollowerMsgVpnUri = ApiClient.convertToType(data['configSyncResyncFollowerMsgVpnUri'], 'String');
      if (data.hasOwnProperty('configSyncResyncLeaderMsgVpnUri'))
        obj.configSyncResyncLeaderMsgVpnUri = ApiClient.convertToType(data['configSyncResyncLeaderMsgVpnUri'], 'String');
      if (data.hasOwnProperty('configSyncResyncLeaderRouterUri'))
        obj.configSyncResyncLeaderRouterUri = ApiClient.convertToType(data['configSyncResyncLeaderRouterUri'], 'String');
      if (data.hasOwnProperty('guaranteedMsgingDefragmentMsgSpoolFilesStartUri'))
        obj.guaranteedMsgingDefragmentMsgSpoolFilesStartUri = ApiClient.convertToType(data['guaranteedMsgingDefragmentMsgSpoolFilesStartUri'], 'String');
      if (data.hasOwnProperty('guaranteedMsgingDefragmentMsgSpoolFilesStopUri'))
        obj.guaranteedMsgingDefragmentMsgSpoolFilesStopUri = ApiClient.convertToType(data['guaranteedMsgingDefragmentMsgSpoolFilesStopUri'], 'String');
 ...
 * @member {String} configSyncAssertLeaderMsgVpnUri
 */
BrokerLinksModel.prototype.configSyncAssertLeaderMsgVpnUri = undefined;

/**
 * The URI of this Broker's Assert Leader Router action. Available since 2.22.
 * @member {String} configSyncAssertLeaderRouterUri
 */
BrokerLinksModel.prototype.configSyncAssertLeaderRouterUri = undefined;

/**
 * The URI of this Broker's Resync Follower Message VPN action. Available since 2.22.
 * @member {String} configSyncResyncFollowerMsgVpnUri
 */
BrokerLinksModel.prototype.configSyncResyncFollowerMsgVpnUri = undefined;

/**
 * The URI of this Broker's Resync Leader Message VPN action. Available since 2.22.
 * @member {String} configSyncResyncLeaderMsgVpnUri
 */
BrokerLinksModel.prototype.configSyncResyncLeaderMsgVpnUri = undefined;

/**
 * The URI of this Broker's Resync Leader Router action. Available since 2.22.
 * @member {String} configSyncResyncLeaderRouterUri
 */
BrokerLinksModel.prototype.configSyncResyncLeaderRouterUri = undefined;

/**
 * The URI of this Broker's Start Defragmentation action. Available since 2.18.
 * @member {String} guaranteedMsgingDefragmentMsgSpoolFilesStartUri
 */
BrokerLinksModel.prototype.guaranteedMsgingDefragmentMsgSpoolFilesStartUri = undefined;

/**
 * The URI of this Broker's Stop Defragmentation action. Available since 2.18.
 * @member {String} guaranteedMsgingDefragmentMsgSpoolFilesStopUri
 */
BrokerLinksModel.prototype.guaranteedMsgingDefragmentMsgSpoolFilesStopUri = undefined;
