...
export class MsgVpnTopicEndpointLinksModel {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cancelReplayUri'))
        obj.cancelReplayUri = ApiClient.convertToType(data['cancelReplayUri'], 'String');
      if (data.hasOwnProperty('clearStatsUri'))
        obj.clearStatsUri = ApiClient.convertToType(data['clearStatsUri'], 'String');
      if (data.hasOwnProperty('copyMsgFromQueueUri'))
        obj.copyMsgFromQueueUri = ApiClient.convertToType(data['copyMsgFromQueueUri'], 'String');
      if (data.hasOwnProperty('copyMsgFromReplayLogUri'))
        obj.copyMsgFromReplayLogUri = ApiClient.convertToType(data['copyMsgFromReplayLogUri'], 'String');
      if (data.hasOwnProperty('copyMsgFromTopicEndpointUri'))
        obj.copyMsgFromTopicEndpointUri = ApiClient.convertToType(data['copyMsgFromTopicEndpointUri'], 'String');
      if (data.hasOwnProperty('deleteMsgsUri'))
        obj.deleteMsgsUri = ApiClient.convertToType(data['deleteMsgsUri'], 'String');
      if (data.hasOwnProperty('msgsUri'))
        obj.msgsUri = ApiClient.convertToType(data['msgsUri'], 'String');
      if (data.hasOwnProperty('startReplayUri'))
        obj.startReplayUri = ApiClient.convertToType(data['startReplayUri'], 'String');
 ...
 * @member {String} cancelReplayUri
 */
MsgVpnTopicEndpointLinksModel.prototype.cancelReplayUri = undefined;

/**
 * The URI of this Topic Endpoint's Clear Stats action.
 * @member {String} clearStatsUri
 */
MsgVpnTopicEndpointLinksModel.prototype.clearStatsUri = undefined;

/**
 * The URI of this Topic Endpoint's Copy Message From Queue action. Available since 2.29.
 * @member {String} copyMsgFromQueueUri
 */
MsgVpnTopicEndpointLinksModel.prototype.copyMsgFromQueueUri = undefined;

/**
 * The URI of this Topic Endpoint's Copy Message From Replay Log action. Available since 2.29.
 * @member {String} copyMsgFromReplayLogUri
 */
MsgVpnTopicEndpointLinksModel.prototype.copyMsgFromReplayLogUri = undefined;

/**
 * The URI of this Topic Endpoint's Copy Message From Topic Endpoint action. Available since 2.29.
 * @member {String} copyMsgFromTopicEndpointUri
 */
MsgVpnTopicEndpointLinksModel.prototype.copyMsgFromTopicEndpointUri = undefined;

/**
 * The URI of this Topic Endpoint's Delete All Messages action. Available since 2.28.
 * @member {String} deleteMsgsUri
 */
MsgVpnTopicEndpointLinksModel.prototype.deleteMsgsUri = undefined;
 ...
 * @member {String} startReplayUri
 */
MsgVpnTopicEndpointLinksModel.prototype.startReplayUri = undefined;
