...
export class MsgVpnLinksModel {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('clearMsgSpoolStatsUri'))
        obj.clearMsgSpoolStatsUri = ApiClient.convertToType(data['clearMsgSpoolStatsUri'], 'String');
      if (data.hasOwnProperty('clearReplicationStatsUri'))
        obj.clearReplicationStatsUri = ApiClient.convertToType(data['clearReplicationStatsUri'], 'String');
      if (data.hasOwnProperty('clearServiceStatsUri'))
        obj.clearServiceStatsUri = ApiClient.convertToType(data['clearServiceStatsUri'], 'String');
 ...
 * @member {String} clearMsgSpoolStatsUri
 */
MsgVpnLinksModel.prototype.clearMsgSpoolStatsUri = undefined;

/**
 * The URI of this Message VPN's Clear Stats action.
 * @member {String} clearReplicationStatsUri
 */
MsgVpnLinksModel.prototype.clearReplicationStatsUri = undefined;

/**
 * The URI of this Message VPN's Clear Stats action.
 * @member {String} clearServiceStatsUri
 */
MsgVpnLinksModel.prototype.clearServiceStatsUri = undefined;

/**
 * The URI of this Message VPN's Clear Stats action.
 * @member {String} clearStatsUri
 */
MsgVpnLinksModel.prototype.clearStatsUri = undefined;
