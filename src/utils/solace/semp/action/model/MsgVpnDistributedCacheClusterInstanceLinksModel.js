...
export class MsgVpnDistributedCacheClusterInstanceLinksModel {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('backupCachedMsgsUri'))
        obj.backupCachedMsgsUri = ApiClient.convertToType(data['backupCachedMsgsUri'], 'String');
      if (data.hasOwnProperty('cancelBackupCachedMsgsUri'))
        obj.cancelBackupCachedMsgsUri = ApiClient.convertToType(data['cancelBackupCachedMsgsUri'], 'String');
      if (data.hasOwnProperty('cancelRestoreCachedMsgsUri'))
        obj.cancelRestoreCachedMsgsUri = ApiClient.convertToType(data['cancelRestoreCachedMsgsUri'], 'String');
      if (data.hasOwnProperty('clearEventUri'))
        obj.clearEventUri = ApiClient.convertToType(data['clearEventUri'], 'String');
      ...
      if (data.hasOwnProperty('restoreCachedMsgsUri'))
        obj.restoreCachedMsgsUri = ApiClient.convertToType(data['restoreCachedMsgsUri'], 'String');
      if (data.hasOwnProperty('startUri'))
        obj.startUri = ApiClient.convertToType(data['startUri'], 'String');
 ...
 * @member {String} backupCachedMsgsUri
 */
MsgVpnDistributedCacheClusterInstanceLinksModel.prototype.backupCachedMsgsUri = undefined;

/**
 * The URI of this Cache Instance's Cancel Backup Cached Messages action.
 * @member {String} cancelBackupCachedMsgsUri
 */
MsgVpnDistributedCacheClusterInstanceLinksModel.prototype.cancelBackupCachedMsgsUri = undefined;

/**
 * The URI of this Cache Instance's Cancel Restore Cached Messages action.
 * @member {String} cancelRestoreCachedMsgsUri
 */
MsgVpnDistributedCacheClusterInstanceLinksModel.prototype.cancelRestoreCachedMsgsUri = undefined;

/**
 * The URI of this Cache Instance's Clear Event action.
 * @member {String} clearEventUri
 */
MsgVpnDistributedCacheClusterInstanceLinksModel.prototype.clearEventUri = undefined;

/**
 * The URI of this Cache Instance's Clear Stats action.
 * @member {String} clearStatsUri
 */
MsgVpnDistributedCacheClusterInstanceLinksModel.prototype.clearStatsUri = undefined;

/**
 * The URI of this Cache Instance's Delete Messages action.
 * @member {String} deleteMsgsUri
 */
MsgVpnDistributedCacheClusterInstanceLinksModel.prototype.deleteMsgsUri = undefined;

/**
 * The URI of this Cache Instance's Restore Cached Messages action.
 * @member {String} restoreCachedMsgsUri
 */
MsgVpnDistributedCacheClusterInstanceLinksModel.prototype.restoreCachedMsgsUri = undefined;

/**
 * The URI of this Cache Instance's Start Cache Instance action.
 * @member {String} startUri
 */
MsgVpnDistributedCacheClusterInstanceLinksModel.prototype.startUri = undefined;
